...
- [improvement-report] IR-002: sync overwrites the install work-tree with no reviewable or revertable unit (shipped install-side, --commit) → wiki/projects/microwave/idea-box/IR-002-sync-has-no-reviewable-unit.md
